...
The mean bill length is `r mean(pull(penguins, bill_length_mm), na.rm = TRUE)`. Values were measured between the years of `r range(pull(penguins, year), na.rm = TRUE)`. 
